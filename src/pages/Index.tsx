      ...
      <main className="max-w-2xl mx-auto px-4 mt-6 space-y-4">
        ...
        {isMobile ? (
          <Drawer open={calendarOpen} onOpenChange={setCalendarOpen}>
            <DrawerContent className="rounded-t-[28px] border-none bg-white px-3 pb-6">
              <DrawerHeader className="pb-2 text-center">
                <DrawerTitle>اختيار التاريخ</DrawerTitle>
                <DrawerDescription>
                  اختر التاريخ ثم سيتم إرسال التقرير مباشرة.
                </DrawerDescription>
              </DrawerHeader>
              <div className="mx-auto w-full max-w-sm rounded-[24px] bg-white p-2">
                {calendarNode}
              </div>
            </DrawerContent>
          ...
          <Dialog open={calendarOpen} onOpenChange={setCalendarOpen}>
            <DialogContent className="w-[calc(100vw-2rem)] max-w-md rounded-[28px] border-none bg-white p-4 shadow-[0_24px_80px_rgba(15,23,42,0.22)]">
              <DialogHeader className="space-y-1 text-center">
                <DialogTitle>اختيار التاريخ</DialogTitle>
                <DialogDescription>
                  اختر التاريخ ثم سيتم إرسال التقرير مباشرة.
                </DialogDescription>
              </DialogHeader>
              <div className="mx-auto rounded-[24px] bg-white p-2">
                {calendarNode}
              </div>
            </DialogContent>
